...
```sh
bash <(curl -s https://raw.githubusercontent.com/dunckr/dotfiles/main/install.sh)
```
...
<!-- Definitions -->
[screenshot]: https://raw.githubusercontent.com/dunckr/dotfiles/main/.github/screenshot.png
